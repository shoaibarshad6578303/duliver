    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="close" id="close_model" data-dismiss="modal" aria-hidden="true">
            ×
          </button>
        ...
        <div class="modal-body">
          <div>
            ...
            <div class="row">
              ...
              <input type="number" name="city_value" id="city_value">
    ...
    $(function() {
      ...
      $(document).on('click', '#set_default_value', function() {
        ...
        $.ajax({
          ...
          type: "POST",
          data: {
            'shipper_id': $('#shipper_id_modal').val(),
            'cities_rate': city_rate
          },
          success: function(response) {
            console.log(response);
            // $('#rate_modal').toggle('close');
      ...
      $(document).on('click', '#set_city_value', function() {

         var city_value=$('#city_value').val();
         var city=$('#city').val();
         
         var id=$('#shipper_id_modal').val();
        ...
        //  console.log(id);
         ...
         $.ajax({
          url: 'update_one_city_value',
          type: "post",
          data: {value :city_value, city: city, id: id},
          // dataType: 'JSON',
          success: function(response) {
