                        ...
                        <div class="row smart-form">
                            ...
                            <section id="city" class="col col-sm-3">
                                <div class="form-group">
                                    ...
                                    <option value="1">Abu Dhabi</option><option value="2">Dubai</option><option value="3">Sharjah</option><option value="4">Ajman</option><option value="5">Al Ain</option><option value="6">Fujeriah</option><option value="7">Um Al Qwain</option><option value="8">Ras Al Khaimah</option><option value="9">Out of Service Area</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="6" aria-labelledby="select2-ddlCity-container"><span class="select2-selection__rendered" id="select2-ddlCity-container" title="Abu Dhabi">Abu Dhabi</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                            </section>
                            ...
                            <div class="row" id="_1">
                                ...
                                <section class="col col-sm-3">
                                    <label class="textarea">
                                        ...
                                        <textarea id="txtPieceDesc_1" rows="2" class="form-control" name="comment" placeholder="Tell us about 1st Piece.." 11"=""></textarea>
                                    </label>
                                </section>
                                <section class="col col-sm-3">
                                    <label class="input">      
