...
$CI->app_menu->add_sidebar_children_item('human-resource', [
        ...
        $CI->app_menu->add_sidebar_menu_item('shipper-details', [
                'name' => _l('Shipper Details'),
                'href' => admin_url('shipper-details'),
                'position' => 1,
                'icon' => 'fa fa-anchor',
                ]);
                
                $CI->app_menu->add_sidebar_children_item('shipper-details', [
                'slug' => 'shippers_detail',
                'name' => _l('Shipper Details'),
                'href' => admin_url('shipper_detail'),
                'position' => 5,
                'icon' => 'fa fa-anchor'
                ]);
                $CI->app_menu->add_sidebar_children_item('shipper-details', [
                'slug' => 'shippers_rate',
                'name' => _l('Shipper Rate'),
                'href' => admin_url('shipper_detail/rate'),
                'position' => 5,
                'icon' => 'fa fa-dollar'
                ]);
                $CI->app_menu->add_sidebar_children_item('shipper-details', [
                'slug' => 'add_shippers',
                'name' => _l('Add Shipper'),
                'href' => admin_url('shipper_detail/add'),
                'position' => 5,
                'icon' => 'fa fa-plus'
                ]);
                
                $CI->app_menu->add_sidebar_menu_item('shipment-details', [
                'name' => _l('Shipment Details'),
                'href' => admin_url('shipment_details'),
                'position' => 1,
                'icon' => 'fa fa-anchor',
                ]);
                ...
                'slug' => 'place-order',
                'name' => _l('Place Order'),
                'href' => admin_url('shipment_details/place_order'),
                'position' => 5,
                'icon' => 'fa fa-cube'
                ]);
                $CI->app_menu->add_sidebar_children_item('shipment-details', [
                'slug' => 'operation-dashboard',
                'name' => _l('Operation Dashboard'),
                'href' => admin_url('shipment_details/operation_dashboard'),
                'position' => 5,
                'icon' => 'fa fa-reply'
                ]);
